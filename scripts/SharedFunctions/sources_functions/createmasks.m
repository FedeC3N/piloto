function mri = createmasks ( mri )

% Extracts the brain and scalp voxels as probabilities.
scalp     = mri.anatomy;
...
% Creates the skull as a dilation of 6mm outside the brain.
skull     = imdilate ( brain, strel_bol (6) );
