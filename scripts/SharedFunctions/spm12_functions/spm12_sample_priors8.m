function [s,ds1,ds2,ds3] = spm12_sample_priors8(tpm,x1,x2,x3)
% Sample prior probability maps
% FORMAT [s,ds1,ds2,ds3] = spm12_sample_priors8(tpm,x1,x2,x3)
% b           - a cell array containing the tissue probability
%               data (see spm12_load_priors)
% x1,x2,x3    - coordinates to sample
% s           - sampled values
% ds1,ds2,ds3 - spatial derivatives of sampled values
%
% This function is intended to be used in conjunction with spm12_load_priors.
% V = spm12_vol(P);
...
% John Ashburner
% $Id: spm12_sample_priors8.m 5962 2014-04-17 12:47:43Z spm $
